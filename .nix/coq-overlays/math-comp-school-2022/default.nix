...
{ lib, mkCoqDerivation, which, coq,
  ...
  mathcomp-solvable, mathcomp-character, mathcomp-field,
  mathcomp-zify, mathcomp-algebra-tactics,
  ## declare extra dependencies here, to be used in propagateBuildInputs e.g.
  # , mathcomp, coq-elpi
  version ? null }:

with lib; mkCoqDerivation {
  pname = "math-comp-school-2022";
  ## you can configure the domain, owner and repository, the default are:
  # repo = "math-comp-school-2022";
  # owner = "coq-community";
  # domain = "github.com";
...
## - or its version is overridden (by a branch, PR, url or path) in `.nix/config.nix`.
  ...
  propagatedBuildInputs = [ mathcomp-ssreflect mathcomp-fingroup
                            mathcomp-algebra mathcomp-solvable
                            mathcomp-character mathcomp-field
                            mathcomp-zify mathcomp-algebra-tactics
                            coq-elpi hierarchy-builder ]
     ++ (with coq.ocamlPackages; [ dune_2 ocaml ]);
